...
from event_rsvp.settings import REQUIRED_FIELDS_CHOICES
...
class Event(models.Model):
    ...
    """
    Commenting out the Filer Image field due to some errors on the dependency. 
    ...
    def get_absolute_url(self, url='event_rsvp:rsvp_event_detail'):
    ...
    def get_update_url(self):
        return self.get_absolute_url(url='event_rsvp:rsvp_event_update')

    def get_delete_url(self):
        return self.get_absolute_url(url='event_rsvp:rsvp_event_delete')

    def get_template_url(self):
        return reverse('event_rsvp:rsvp_event_create_from_template', kwargs={
            'pk': self.pk})
