# Generated by Django 2.0.1 on 2018-01-26 04:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(choices=[('Freshman', 'Fr'), ('Sophomore', 'Sp'), ('Junior', 'Jr'), ('Senior', 'Sr')], default='Fr', max_length=10)),
            ],
            options={
                'abstract': False,
            },
